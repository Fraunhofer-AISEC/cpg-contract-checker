...
contract rNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public maxSupply = 99999999999999999;
    ...
    function mint(string memory _linkURL) public payable returns (uint256) {
    ...
    function mintOLD(uint256 _mintAmount) public payable {
        uint256 supply = totalSupply();
