...
contract RandomContract is Context, IERC20, Ownable {
    ...
    uint256 public _previousBurnFee = 2;

    uint256 public _liquidityFee = 4; 
    uint256 private _previousLiquidityFee = _liquidityFee;

    
    uint256 public _devFee = _liquidityFee * 25;
    uint256 private _previousExtraBurnFee = _devFee;
    ...
    constructor () public {
        ...
        _devWalletAddress = 0x0000000000000000000000000000000000000001;
        ...
        _isExcluded[_devWalletAddress] = true;
    ...
    function calculateContractTokens(uint256 contractTokenBalance) private pure returns (uint256, uint256, uint256){
        uint256 lofiTokens = contractTokenBalance.mul(0);
        uint256 bnbTokens = contractTokenBalance.mul(0);
        uint256 bnbToDevTokens = contractTokenBalance.mul(0);
        return (lofiTokens, bnbTokens, bnbToDevTokens);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        (uint256 lofiTokens, uint256 bnbTokens, uint256 bnbToDevTokens) = calculateContractTokens(contractTokenBalance);
        
        
        
        
        uint256 tokensToSwapToBnb = bnbTokens.add(bnbToDevTokens);
        ...
        addLiquidity(lofiTokens, newBalance);

        
        sendBNBToDevWallet(bnbToDevTokens);
        emit SwapAndLiquify(lofiTokens, newBalance, tokensToSwapToBnb);
    }
