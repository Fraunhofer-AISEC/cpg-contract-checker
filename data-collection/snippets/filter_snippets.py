...
SNIPPETS_DATASET = [
    ("stack_overflow", "parser/snippet_parser/stack_overflow/successfully_parsed"),
    ("ethereum_stack_exchange", "parser/snippet_parser/ethereum_stack_exchange/successfully_parsed")
]
