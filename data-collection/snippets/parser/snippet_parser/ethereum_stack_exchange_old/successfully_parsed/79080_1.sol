...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    function transferFrom(address _from, address _to, uint _value) public onlyPayloadSize(3 * 32) virtual override {
...
contract ExampleToken is Pausable, StandardToken, BlackList {
    ...
    function transfer(address _to, uint _value) public whenNotPaused override {
    ...
    function transferFrom(address _from, address _to, uint _value) public whenNotPaused override {
