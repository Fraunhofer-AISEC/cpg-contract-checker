...
import "https://github.com/1001-digital/erc721-extensions/contracts/RandomlyAssigned.sol";

contract VasikTest is ERC721Enumerable, Ownable, RandomlyAssigned {  
    ...
    constructor () ERC721 ("Vasik One mint", "OneMintVasik") RandomlyAssigned(MAX_SUPPLY,1) {
        price = initial_price;
