...
class SolidityListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SolidityParser#semi.
    def enterSemi(self, ctx:SolidityParser.SemiContext):
        pass

    # Exit a parse tree produced by SolidityParser#semi.
    def exitSemi(self, ctx:SolidityParser.SemiContext):
        pass
